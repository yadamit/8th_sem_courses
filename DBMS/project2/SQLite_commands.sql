...
CREATE TABLE HasQualification (
 ssn TEXT REFERENCES Employee(ssn),
...
INSERT INTO Project (projectid, location, start, finish)
VALUES ('PR01','Espoo', '2019-03-09', '2019-05-24');


INSERT INTO Subproject (subID, prerequisiteID, start, finish, partOfProject)
VALUES
('SPR01-01', NULL, '2019-03-09', '2019-04-20', 'PR01'),
('SPR01-02', 'SPR01-01', '2019-04-20', '2019-05-24', 'PR01');
...
INSERT INTO HasQualification (ssn, qualification)
VALUES
...
INSERT INTO QualificationRequirements (qualification, subID, countOf)
VALUES
('designer', 'SPR01-01', 1),
...
INSERT INTO Absences (absentSSN, start, end, subSSN)
VALUES ('240383-107M', ' '2019-03-12', '2019-03-15', '040686-034K');


INSERT INTO EmployeeAssignments (ssn, subID)
VALUES
...
INSERT INTO Machines (model, manufacturer, description, size, fuelConsumption)
VALUES
...
INSERT INTO OwnedMachines (machineID, model)
VALUES
        ('PD01', 'PK-130-F'),
        ('PD02', 'PK-130-F'),
...
INSERT INTO Maintenance (machineID, start, end)
VALUES ('PD01', '2018-07-15', '2018-07-17');


INSERT INTO MachineAssignments (machineID, start, end, subID)
VALUES
...
INSERT INTO MachineRequirements (model, start, subID, end, modelCount)
VALUES
