...
def get_conditional_probability(data, query, condititions):
    ...
    keys1 = query.keys()
    keys2 = condititions.keys()
    # print(keys1&keys2)
    assert((keys1 & keys2) == set()) # no common keys
    # assert(len(keys1)==1)
    ...
    # TASK 1.1
    #  - Calculate P(A | B...Z)
    num = get_data_frequency(data, combined_dictionary)
    denom = get_data_frequency(data, condititions) + epsilon
    return num/denom
...
def sample(G, X, E, e):
    ...
    for variable in X:
        ...
        if variable in E:
            ...
            value = e[index]
            prob = evaluate_node(G, variable, value, parents)
            w = w*prob
            # =========================================================
            pass
            # =========================================================
